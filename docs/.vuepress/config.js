...
module.exports = {
  ...
  // theme: require.resolve('../../vdoing'), // 使用本地主题 (先将vdoing主题文件下载到本地：https://github.com/xugaoyi/KCloud-Platform-Alibaba)
  ...
  themeConfig: {
    ...
    repo: 'xugaoyi/KCloud-Platform-Alibaba', // 导航栏右侧生成Github链接
    ...
    footer: { // 页脚信息
      ...
      copyrightInfo: 'KCloud-Platform-Alibaba | MIT License', // 博客版权信息，支持a标签
    },
    htmlModules,
  },
