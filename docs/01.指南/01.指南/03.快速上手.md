...
```bash
# clone the project
git clone https://github.com/xugaoyi/KCloud-Platform-Alibaba.git
...
npm run dev # or yarn dev
```
> 仓库地址： <https://github.com/xugaoyi/KCloud-Platform-Alibaba>
...
```bash
# clone the project
git clone https://github.com/u2sb/KCloud-Platform-Alibaba-template.git

# enter the project directory
cd KCloud-Platform-Alibaba-template
...
npm run dev # or yarn dev
```
> 仓库地址： <https://github.com/u2sb/KCloud-Platform-Alibaba-template>
...
1. 安装最新的Vdoing主题包：
```sh
npm install KCloud-Platform-Alibaba -D
```
...
```sh
npm update KCloud-Platform-Alibaba
```
